        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
          ...
          <div className="space-y-1">
            {creditData.initialPayment && (
              <p>📝 <strong>Первоначальный взнос:</strong> {creditData.initialPayment} ₼</p>
            )}
            {creditData.collateralRequired && (
              <p>🏦 <strong>Требуется залог</strong></p>
            )}
            {creditData.websiteUrl && (
              <p>
                🔗 <a href={creditData.websiteUrl} target="_blank" className="text-blue-400 underline">Перейти на сайт</a>
              </p>
            )}
          </div>
        </div>
